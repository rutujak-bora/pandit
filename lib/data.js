export const servicesData = {
    'wedding-puja': {
        title: 'Wedding Puja - Top Wedding Pandit in Delhi NCR',
        slug: 'wedding-puja',
        icon: '💑',
    ...
    'griha-pravesh': {
        title: 'Griha Pravesh Puja - Top Pandit for Housewarming Near Me',
        slug: 'griha-pravesh',
        icon: '🏠',
    ...
    'office-opening': {
        title: 'New Office Opening Puja - Top Pandit for Business Blessings',
        slug: 'office-opening',
        icon: '🏢',
        heroImage: '/services/office-opening.png',
        gallery: [
            '/gallery/1.jpeg',
            '/gallery/2.jpeg',
            '/gallery/3.jpeg'
        ...
        significance: {
            title: 'Meaning and Significance',
            content: 'Opening a new office or business venture is a major milestone that requires divine blessings for success, prosperity, and a positive working environment. New Office Opening Puja, also known as Business Vastu Puja or Labh-Sukh Puja, is performed to invoke the blessings of Lord Ganesh, Goddess Lakshmi, and Vastu Purush. This Vedic ceremony purifies the commercial space, removes any existing negative energies, and aligns the office with prosperity-attracting cosmic vibrations. As an experienced Pandit for office opening in Delhi NCR, I ensure that your business begins on the most auspicious note possible.',
            keyPoints: [
                'Invokes blessings for business growth and financial success',
                'Purifies the commercial environment for employees and clients',
                'Corrects Vastu imbalances in the new workplace',
                'Invites Goddess Lakshmi for continuous wealth and abundance',
                'Establishes a shield of protection against business obstacles'
            ]
        },
        benefits: {
            title: 'Professional and Spiritual Benefits',
            spiritual: [
                'Divine protection for the business and its stakeholders',
                'Blessings of Kuber and Lakshmi for financial growth',
                'Removal of "Nazar" (evil eye) and competitive negativity',
                'Positive energy flow (Prana) throughout the workspace',
                'Harmony between the five elements in the business premises'
            ],
            practical: [
                'Attracts loyal clients and profitable opportunities',
                'Enhances employee productivity and job satisfaction',
                'Reduces administrative hurdles and operational delays',
                'Fosters better decision-making and business management',
                'Creates a welcoming and professional atmosphere'
            ]
        },
        auspiciousTime: {
            title: 'Ideal Time to Perform',
            content: 'Business pujan should ideally be performed during Labh, Amrit, or Shubh Choghadiya muhurats on an auspicious day like Thursday, Friday, or Monday. Festivals like Diwali, Dhanteras, and Akshaya Tritiya are also considered excellent for office openings. The muhurat is calculated based on the owner\'s horoscope and the direction of the office entrance.',
            periods: [
                'Auspicious Days: Thursday (Guru), Friday (Shukra), Wednesday (Budh), Monday (Chandra)',
                'Favorable Nakshatras: Pushya, Rohini, Uttara Phalguni, Uttara Ashadha, Shravan',
                'Best Time: Morning hours (Shubh Choghadiya)',
                'Festive Occasions: Dhanteras, Diwali, Akshaya Tritiya, Gudi Padwa',
                'Avoid: Rahu Kaal, eclipse days, and inauspicious tithis'
            ]
        },
        procedure: {
            title: 'Key Rituals and Procedure',
            steps: [
                {
                    name: 'Vastu Shanti & Shuddhi',
                    description: 'Purification of the entire office space using sacred mantras and Ganga Jal'
                },
                {
                    name: 'Ganesh Puja',
                    description: 'Invocation of the Lord of Beginnings to ensure a smooth business journey'
                },
                {
                    name: 'Lakshmi-Kuber Puja',
                    description: 'Special worship of the deities of wealth and treasury for financial success'
                },
                {
                    name: 'Navagraha Puja',
                    description: 'Appeasing the nine planets to ensure smooth business operations'
                },
                {
                    name: 'Office Entrance (Toran) Sthapana',
                    description: 'Installation of sacred symbols at the main door to welcome positivity'
                },
                {
                    name: 'Havan/Homa',
                    description: 'Sacred fire ritual to energize the workspace with Vedic vibrations'
                }
            ],
            duration: '2-3 hours'
        },
        additionalInfo: {
            title: 'Important Information',
            points: [
                'The main entrance should be decorated with mango leaves and marigold flowers',
                'The owner should ideally wear clean, traditional attire',
                'Consult with Pandit Ji for the most accurate muhurat for your specific trade',
                'It is auspicious to distribute sweets (prasad) to all staff and visitors',
                'Ensure the North-East corner of the office is clean and clutter-free',
                'Lighting a Diya in the Pooja room/corner daily after opening is recommended'
            ]
        },
        samagriIncluded: [
            'All Havan samagri and wood',
            'Kalash and sacred items',
            'Lakshmi-Ganesh idols/photos (if required)',
            'Flowers, fruits, and sweets for offering',
            'Vedic mantra materials',
